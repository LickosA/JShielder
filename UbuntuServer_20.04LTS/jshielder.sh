...
Developed By Jason Soto @Jsitech and Updated by @LickosA"
echo
echo
...
install_secure_php(){
    ...
    apt install -y php7.4-pear
    apt install -y libapache2-mod-php7.4
    echo ""
    echo -n " Replacing php.ini..."
    spinner
    cp templates/php /etc/php/7.4/apache2/php.ini; echo " OK"
    cp templates/php /etc/php/7.4/cli/php.ini; echo " OK"
...
install_secure_php_nginx(){
    ...
    spinner
    sed -i 's/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/g' /etc/php/7.4/fpm/php.ini; echo " OK"
...
additional_packages(){
    ...
    echo include_path = ".:/usr/share/phpunit:/usr/share/phpunit/PHPUnit" >> /etc/php/7.4/cli/php.ini
    echo include_path = ".:/usr/share/phpunit:/usr/share/phpunit/PHPUnit" >> /etc/php/7.4/apache2/php.ini
    service apache2 restart
    say_done
}
